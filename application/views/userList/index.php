<div class="container-fluid">
    <div>
        <ul class="nav nav-tabs">
            ...
            <center><li class="text-center" style="margin-top: 10px;"><a><strong>User List</strong></a></li></center>
        </ul>
                                    ...
                                    <tbody>     
                                        <?php foreach ($getUserData as $row): ?>
                                            <tr>
                                                ...
                                                <td data-field="pin"><?php echo $row['pin']; ?></td>


                                                <td data-field="state"><?php echo $row['state']; ?></td>
                                                <td data-field="country"><?php echo $row['country']; ?></td>
                                                <td><?php echo $row['loginCont']; ?></td>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $('.fa-save').click(function () {
                                ...
                                var city = $(this).closest('tr').children('td:eq(10)').text();
                                var pincode = $(this).closest('tr').children('td:eq(11)').text();
                                var state = $(this).closest('tr').children('td:eq(12)').text();
                                var country = $(this).closest('tr').children('td:eq(13)').text();
                                $.ajax({
                                    type: 'POST',
                                    url: 'UserList/updateWeb',
                                    data: {'id': id, 'date': date, 'time': time, 'name': name, 'mobileNo': mobileNo, 'password': password, 'email': email, 'address': address, 'area': area, 'city': city, 'pincode': pincode, 'state': state, 'country': country},
